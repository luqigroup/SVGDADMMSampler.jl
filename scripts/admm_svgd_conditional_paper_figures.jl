...
ax.set_ylabel(L"$x_2$")
tight_layout()
wsave(joinpath(plot_save, "prior.png"), fig)
close(fig)
...
ax.set_ylabel(L"$y_2$")
tight_layout()
wsave(joinpath(plot_save, "data.png"), fig)
close(fig)
...
tight_layout()
wsave(joinpath(plot_save, "svgd-posteriors.png"), fig)
close(fig)
...
tight_layout()
wsave(joinpath(plot_save, "plain-svgd-posteriors.png"), fig)
close(fig)
...
tight_layout()
wsave(joinpath(plot_save, "qq-plots-svgd-vs-admm.png"), fig)
close(fig)
